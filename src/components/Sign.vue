	...
	<form class="sign-form form form-aligned">
		...
		<fieldset>
			<div class="control-group">
				<input type="text" class="input-1" placeholder="Username" v-model="user.name" v-bind:class="{invalid:nameInvalid}" v-focus="nameInvalid"/>
			</div>
			<div class="control-group">
				<input type="password" class="input-1" placeholder="Password" v-model="user.pass" v-bind:class="{invalid:passInvalid}"  v-focus="nameInvalid"/>
			</div>
		</fieldset>
